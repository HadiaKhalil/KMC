    ...
    <div className="bg-gradient-to-b from-white via-orange-100 to-white ">
      <div className="main-container ">
            ...
            >
              ...
              <div className="flex flex-col gap-3 mt-auto">
                ...
                <p
                  ...
                  leading-[24px] md:leading-[28px] text-[#051636]"
                >
                  {card.text}
                </p>
              </div>
        ...
        <div className="flex justify-center mt-8">
          <Button>
            See What These Certifications Mean for You
          </Button>
        </div>
        <p
          className="mt-6 text-center font-[Be_Vietnam_Pro] 
        ...
        >
          <span className="text-[#EE7A30] font-semibold">These aren’t marketing badges</span>
          , they’re signals that{" "}
